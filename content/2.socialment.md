...
---
#description
For this configured Azure provider, the redirect URI would be `https://DOMAIN/login/azure/redirect`:br :br The callback URI would be `https://DOMAIN/login/azure/callback`
::
