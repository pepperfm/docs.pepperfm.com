...
<template>
  <div>
    <svg class="hidden dark:block" fill="#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="2 6 20 12">
    ...
    <svg class="dark:hidden" fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="2 6 20 12">
      <g id="SVGRepo_bgCarrier" stroke-width="0" />
      <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
      <g id="SVGRepo_iconCarrier">
        <rect width="32" height="32" fill="none" />
